...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `crud`(`id`, `picture`, `first_name`, `last_name`, `email`, `gender`) VALUES (NULL,'$picture','$first_name','$last_name','$email','$gender')";

   $result = mysqli_query($conn, $sql);

   if ($result) {
      header("Location: index.php?msg=user ajouter");
   } else {
